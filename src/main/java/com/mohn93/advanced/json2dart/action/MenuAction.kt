...
import com.mohn93.advanced.json2dart.*
import com.mohn93.advanced.json2dart.repos.StorageRepo
import com.mohn93.advanced.json2dart.ui.JsonInputDialog
import com.mohn93.advanced.json2dart.utils.JSerializerGenerator
import com.mohn93.advanced.json2dart.utils.JsonSerializerGenerator
...
class Json2DartAction : AnAction() {
    ...
    override fun actionPerformed(event: AnActionEvent) {
        ...
        JsonInputDialog(project) {
            ...
            val classGenerator = if (classOptions.annotationOption == AnnotationOption.JsonSerializer) JsonSerializerGenerator(classOptions, fileName) else JSerializerGenerator(classOptions, fileName)
